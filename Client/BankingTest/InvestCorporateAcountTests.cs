...
{
    [TestClass]
    public class InvestCorporateAcountTests
    {
        private readonly BankingService _bankingService;

        public InvestCorporateAcountTests()
        {
        ...
        public async Task Deposit()
        {
            try
            {
                var sucessful = await _bankingService.SetupBankAsync(AccountTypes.InvestmentCorporate ,10000.0M);
